...
function CommentQ (prop) {
    const empty = ["","",""]
    const emptyJsx = empty.map(function(ele,i){
        return (
            <div key = {i} className="group bg-white rounded-[15px] p-[20px_20px_20px_22px] hover:bg-[#F9D783]">
                <div className="flex justify-between">
                    <img className="size-14.5 rounded-[50%]" src= {img17} alt="" />
    ...
    return(
        <section className="opacity-0 transform-[translateY(30px)]" ref={function(ele){return prop.data.current[4] = ele}}> 
            <div className="container">
                <div className="flex-col-reverse flex justify-between lg:flex-row">
                    <img className="w-full h-84.25 rounded-[15px] lg:w-[51.24%]" src={img16} alt="" />
                    <div className="mb-13.75 lg:w-[36.48%] ">
                        <h2 className="text-2xl text-center mb-3.25 md:text-start md:text-4xl">3500+ Happy Clients Said To Us They Are Satisfied</h2>
                ...
                <div className="mx-auto flex-col w-[85%] flex justify-center gap-2 relative -top-28.25 lg:w-[initial] lg:flex-row">
                    {emptyJsx}
                </div>
            </div>
        </section>
